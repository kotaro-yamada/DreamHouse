...
=begin     
   ...
   buyer_house_purchase_offers GET    /buyer/houses/:house_id/purchase_offers(.:format)                                        buyer/purchase_offers#index
                               POST   /buyer/houses/:house_id/purchase_offers(.:format)                                        buyer/purchase_offers#create
new_buyer_house_purchase_offer GET    /buyer/houses/:house_id/purchase_offers/new(.:format)                                    buyer/purchase_offers#new
    buyer_house_purchase_offer GET    /buyer/houses/:house_id/purchase_offers/:id(.:format)                                    buyer/purchase_offers#show
                               DELETE /buyer/houses/:house_id/purchase_offers/:id(.:format)                                    buyer/purchase_offers#destroy
      buyer_house_visit_offers GET    /buyer/houses/:house_id/visit_offers(.:format)                                           buyer/visit_offers#index
                               POST   /buyer/houses/:house_id/visit_offers(.:format)                                           buyer/visit_offers#create
   new_buyer_house_visit_offer GET    /buyer/houses/:house_id/visit_offers/new(.:format)                                       buyer/visit_offers#new
       buyer_house_visit_offer GET    /buyer/houses/:house_id/visit_offers/:id(.:format)                                       buyer/visit_offers#show
                               PATCH  /buyer/houses/:house_id/visit_offers/:id(.:format)                                       buyer/visit_offers#update
                               PUT    /buyer/houses/:house_id/visit_offers/:id(.:format)                                       buyer/visit_offers#update
                               DELETE /buyer/houses/:house_id/visit_offers/:id(.:format)                                       buyer/visit_offers#destroy
            ...
            seller_resign_page GET    /seller/selleers/resign_page(.:format)                                                   seller/sellers#resign_page
