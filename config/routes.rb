Rails.application.routes.draw do
  ...
  namespace :buyer do
    ...
    resource :purchase_offers, only: [:show, :new, :create, :destroy]
...
cancel_seller_registration GET    /sellers/cancel(.:format)                                                                devise/registrations#cancel
 ...
 new_buyer_purchase_offers GET    /buyer/purchase_offers/new(.:format)                                                     buyer/purchase_offers#new
     buyer_purchase_offers GET    /buyer/purchase_offers(.:format)                                                         buyer/purchase_offers#show
                           DELETE /buyer/purchase_offers(.:format)                                                         buyer/purchase_offers#destroy
                           POST   /buyer/purchase_offers(.:format)                                                         buyer/purchase_offers#create
              buyer_houses GET    /buyer/houses(.:format)                                                                  buyer/houses#show
     buyer_searches_search GET    /buyer/searches/search(.:format)                                                         buyer/searches#search
                buyer_home GET    /buyer/homes/home(.:format)                                                              buyer/homes#home
